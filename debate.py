...
_GROK_MODEL = os.environ.get("GROK_MODEL", "grok-4.20-multi-agent-0309")
...
def run_debate(topic: str, framework: str, max_rounds: int = 4) -> str:
    ...
    # Spanish translation — generated by Grok
    print("\nGenerating Spanish translation (ES)...")
    es_content = call_grok(SYSTEM_TRANSLATOR, en_content, temperature=0.2)
